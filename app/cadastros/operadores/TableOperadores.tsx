...
export default function TableOperadores({ items, refresh, openEditModal, openAddModal }: any) {
                ...
                <TableBody items={listItems} emptyContent={'Não foram encontrados registros.'}>
                    {(item: any) => (
                        <TableRow key={item.codigo}>
                            ...
                            <TableCell>
                                <div className="flex flex-col">
                                    <p className="text-bold text-sm capitalize truncate">{item.identificador}</p>
                                </div>
                            </TableCell>
                            <TableCell>
                                <div className="flex flex-col">
                            ...
                            <TableCell>
                                <div className="flex flex-col">
                                    <p className="text-bold text-sm capitalize truncate">{item.telefoneCelular}</p>
                                </div>
                            </TableCell>
                            <TableCell>
                                <div className="flex flex-col">
                                    <p className="text-bold text-sm capitalize truncate">{item.tipoPerfil}</p>
                                </div>
                            </TableCell>
                            <TableCell>
                                <div className="flex flex-col">
                                    <p className="text-bold text-sm capitalize truncate">{item.situacao}</p>
                                </div>
                            </TableCell>
                            <TableCell>
